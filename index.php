...
function getGenderFromName ($fullName) {
    ...
    if (mb_substr($socrFIO['surname'], -2, 2) == '0') {
        --$gender;
    }
    if (mb_substr($socrFIO['surname'], -2, 2) == 'ая') {
        --$gender;
    }
    if (mb_substr($socrFIO['name'], -1, 1) == 'а') {
        --$gender;
    }
    if (mb_substr($socrFIO['name'], -1, 1) == 'н') {
        --$gender;
    }
    if (mb_substr($socrFIO['name'], -1, 1) == 'я') {
        --$gender;
    }
    ...
    //Мужской пол:
    if (mb_substr($socrFIO['surname'], -1, 1) == 'й') {
        ++$gender;
    }
    if (mb_substr($socrFIO['surname'], -1, 1) == 'ер') {
        ++$gender;
    }
    if (mb_substr($socrFIO['surname'], -1, 1) == 'ин') {
        ++$gender;
    }
    if (mb_substr($socrFIO['name'], -1, 1) == 'р') {
        ++$gender;
    }
    if (mb_substr($socrFIO['name'], -1, 1) == 'н') {
        ++$gender;
